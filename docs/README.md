...
* Lattice ECP5 `LFE5U-25F-7BG256I` ([product page](https://www.latticesemi.com/Products/FPGAandCPLD/ECP5), [image](images/cl-5a-75b-v82-LFE5U-25F-7BG256I.jpg))
* Winbond `25Q32JVSIQ`, 32 Mbits SPI flash ([datasheet](./w25q32jv_spi_revc_08302016.pdf), [image](images/cl-5a-75b-v82-25Q32JVSIQ.jpg))
* 2x Realtek `RTL8211FP` Gigabit Ethernet PHYs ([datasheet](./RTL8211F-CG-RealtekMicroelectronics.pdf), [image](images/cl-5a-75b-v82-RTL8211FP.jpg))  
  *Note: I can't seem to find anything about the `FP` specifically so it could be an `F` or `FD`*
* 1x ESMT `M12L64322A` 2M 200MHz SDRAM (organized as 4 x 512k x 32bit) ([datasheet](./M12L64322A(2S).pdf), [image](images/cl-5a-75b-v82-M12L64322A.jpg))
* 12x `DP245D` Octal Bidirectional Transceiver (used for level translation to 5V) ([image](images/cl-5a-75b-v82-DP245D.jpg), [datasheet](./DP245D_REV1.7_EN.pdf))  
  *Note: Seems to be from Shenzhen Depu Microelectronics but is just an `74HC245D`*

## PCB overview

![PCB front](images/cl-5a-75b-v82-front.jpg)
![PCB back](images/cl-5a-75b-v82-back.jpg)
...
FPGA power is supplied by 2 buck converters. They are compatible with a TI TLV62565/6 in a SOT23-5 package.

| Buck converter | Vout | Rail  | Description                                                  |
|----------------|------|-------|--------------------------------------------------------------|
| U34            | 1.1V | Vcc   | Core supply voltage                                          |
| U36            | 3.3V | Vccio | I/O Driver supply voltage and 3.3V for the rest of the board |
...
| 1         | N8       | CS#      |
| 2         | T7       | SO       |
| 3         | *na*     | WP#      | Wired to 3v3
| 4         | *na*     | GND      |
| 5         | T8       | SI       |
| 6         | FIXME    | SCK      |
| 7         | *na*     | Hold#    | Wired to 3v3
| 8         | *na*     | VCC      | Wired to 3v3
...
| A9           | C7               |
| A10/AP       | B8               |
| DQM0         | *na*             | Wired to GND
| DQM1         | *na*             | Wired to GND
| DQM2         | *na*             | Wired to GND
| DQM3         | *na*             | Wired to GND
| WE#          | B5               |
| CAS#         | A6               |
| RAS#         | B6               |
| CS#          | *na*             | Wired to GND
| NC           | A7               |
| CKE          | *na*             | Wired to 3.3V
| CLK          | C8               |
